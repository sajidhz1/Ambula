        ...
        <div class="col-sm-3 col-md-3 pull-left">
            <form class="navbar-form navbar-left" method="get" role="search" action="/home/search/" id="main-search">
                <div class="input-group">
                    <input type="text" name="query" class="form-control typeahead" autocomplete="off" data-provide="typeahead" placeholder="Search Recipes" name="q">
        ...
        <div id="navbar-collapse" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                   ...
                   <li class="dropdown" style="font-weight: 500;font-size: medium;">
                       ...
                       <a  class="dropdown-toggle pull-right " id="modal_user" data-toggle="dropdown" href="#"><?=Session::get('name')?><b class="caret"></b></a>
                       <ul class="dropdown-menu">
                               <li><a href="http://localhost/Ambula/home/profile?id=<?=Session::get('uid') ?>">View Profile</a></li>
