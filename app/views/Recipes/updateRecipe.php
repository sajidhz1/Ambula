...
<div class="container-fluid">
    ...
    <div id="recipeUpdateRow" class="row">

        <fieldset style="padding-top: 20px;" id="newRecipeContainer">
            <div id="legend">
                <legend class="new-recipe">Edit Recipe</legend>
            </div>
            <form data-toggle="validator" role="form" method="POST" enctype="multipart/form-data" action="addNewRecipe" id="form1">
                <div class="row">
                    <div id="recipePart1" class="col-lg-5 col-sm-12">
                        <?php $recipe = $this->getRecipeToEdit($this->editRecipeId); ?>
                        <div class="form-group col-lg-9 col-sm-12">
                            <!-- Username -->
                            <label class="control-label" for="recipetitle">Recipe Title</label>

                            <div class="controls">
                                <input type="text" value="<?= $recipe[0]['title']; ?>" id="recipetitle"
                                       name="recipetitle" placeholder="" class="form-control"
                                       required>
                        ...
                        <div class="form-group col-lg-9 col-sm-12">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" name="tags" id="tags" value="<?= $recipe[0]['tags'] ?>"
                                       data-role="tagsinput"/>
                            </div>
                        </div>
                            ...
                            <div class="entry">
                                <div class="input-group">
                                    <div class="col-xs-5 col-sm-5">
                                        <input class="form-control" id="recipetitle" value="<?= $ingredient['title'] ?>"
                                               name="ingname[]" type="text"
                                               placeholder="Example : sugar , salt"/>
                                    </div>
                                    <div class="col-xs-2 col-sm-2">
                                        <input class="form-control" name="amount[]" value="<?= $ingredient['qty'] ?>"
                                               placeholder="0" type="text"/>
                                    </div>
                                    <div class="dropdown col-xs-3 col-sm-3">
                                        <select class="form-control" name="metrics[]">
                                            <option value="">select</option>
                                            <option value="kg" <?php if ($ingredient['units'] === 'kg') {
                                                echo 'selected="selected"';
                                            } ?> >kg
                                            </option>
                                            <option value="g" <?php if ($ingredient['units'] === 'g') {
                                                echo 'selected="selected"';
                                            } ?> >g
                                            </option>
                                            <option value="oz" <?php if ($ingredient['units'] === 'oz') {
                                                echo 'selected="selected"';
                                            } ?> >oz
                                            </option>
                                            <option value="tbspn" <?php if ($ingredient['units'] === 'tbspn') {
                                                echo 'selected="selected"';
                                            } ?> >tbspn
                                            </option>
                                            <option value="tspn" <?php if ($ingredient['units'] === 'tspn') {
                                                echo 'selected="selected"';
                                            } ?> >tspn
                                            </option>
                                            <option value="cup" <?php if ($ingredient['units'] === 'cup') {
                                                echo 'selected="selected"';
                                            } ?> >Cup
                                            </option>
                                            <option value="ml" <?php if ($ingredient['units'] === 'ml') {
                                                echo 'selected="selected"';
                                            } ?> >ml
                                            </option>
                                            <option value="l" <?php if ($ingredient['units'] === 'l') {
                                                echo 'selected="selected"';
                                            } ?> >l
                                            </option>
                                            <option value="packet" <?php if ($ingredient['units'] === 'packet') {
                                                echo 'selected="selected"';
                                            } ?> >packet
                                            </option>
                                            <option value="drops" <?php if ($ingredient['units'] === 'drops') {
                                                echo 'selected="selected"';
                                            } ?> >drops
                                            </option>
                                            <option value="pieces" <?php if ($ingredient['units'] === 'pieces') {
                                                echo 'selected="selected"';
                                            } ?> >pieces
                                            </option>
                        ...
                        foreach ($recipeDescription as $description) {
                            ...
                            <div class="entry2">
                                ...
                                <div class="col-lg-2 col-sm-1">
                                    ...
                                    <button class="choose-image btn btn-primary" data-toggle="modal"
                ...
                <div class="row">
                    <div class="controls col-lg-12 col-sm-12">
                        <button style="margin-top: 10px;font-size: 1.5em"
                                class="btn btn-success submit col-lg-offset-5">
                            Finish
                        </button>
