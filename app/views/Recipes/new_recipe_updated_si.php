...
<div class="row">
    <div id="recipePart1" class="col-lg-5 col-sm-12">
        ...
        <div class="form-group col-lg-9 col-sm-12">
            <!-- E-mail -->
            <label class="control-label" for="email">පින්තුර</label>
            ...
            <span class="help-block with-errors">මෙය වට්ටෝරුව ඉදිරිපත් කිරීමට යොදා ගැනේ</span>
    ...
    <div class="ingredients-control col-lg-7 col-sm-12" id="fields">
        <label class="control-label" for="field1"><h3>අවශ්‍ය දේ</h3></label>
        <br>
            ...
            <div class="input-group">
                ...
                <div class="dropdown col-xs-3 col-sm-3">
                    <select class="form-control" name="metrics[]">
                        ...
                        <option value="කිලෝ">කිලෝ</option>
                        <option value="ග්‍රෑම්">ග්‍රෑම්</option>
                        <option value="අවුන්ස">අවුන්ස</option>
                        <option value="මේස හැදි">මේස හැද</option>
                        <option value="තේ හැදී">තේ හැදි</option>
                        <option value="කෝප්ප">කොප්ප</option>
                        <option value="මිලි ලීටර">මිලි ලීිටර</option>
                        <option value="ලීටර">ලීටර</option>
                        <option value="පැකට්">පැකට්</option>
                        <option value="බින්දු">බින්දු</option>
                        <option value="කෑලි">කෑලි</option>
                        <option value="ස්වල්පයක්">ස්වල්පයක්</option>
                        <option value="ටින්">ටින්</option>
...
<div class="row">
    <div class="col-lg-3 col-sm-12" id="recipePart2" style="">
        ...
        <div id="fields">
            <label class="control-label" for="field1"><h2>ගතවන කාලය</h2></label>
    ...
    <div class="directions-control col-lg-9 col-sm-12" style="" id="fields">
        <label class="control-label" for="field1"><h3>ක්‍රමය</h3></label>

        <div class="entry2">

            <div class="col-lg-8 col-sm-5">
                පියවර<span class="num">1</span>.
