...
<div class="row" id="promotionViewRow">
        ...
        <div class="container-fluid">
            <div class="navbar-header ">
                ...
                <?php if (isset($_SESSION["user_logged_in"]) && $_SESSION["user_account_type"] == 2) { ?>
                    <a class="navbar-brand myCollapseBar" href="/Ambula/promotion/newPromotion"
...
<!-------------------- Modal to inform user to login as commercial user if not --------------------->
            ...
            <div class="modal-body" style="overflow-y: auto;">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
                        ...
                        <span style="font-size: 1.1em;font-weight:800;">Valid From : <span id="from"
                                                                                           class="txt-red"></span></span><br><br>
                        <span style="font-size: 1.1em;font-weight:800;">Valid Till : <span id="till"
                                                                                           class="txt-red"></span></span>
                        <br>
                        <br>
