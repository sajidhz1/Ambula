...
<div class="container-fluid" style="margin-top: 60px;">
	...
	<div class="row productWithSimProds">
					...
					<ul id="similar_products">
						...
						foreach ($reviews as $review) {
							...
							<li style="cursor: default;">
								<div class="col-xs-1">
									<img class="img-circle commenterImage" src="/Ambula/<?= $review['user_avatar']?>/<?= $review['user_name']?>.jpg" style="width: 45px; height: 45px">
								</div>
								<div class="col-xs-11">
									<span style="margin-right: 10px; color: #2682bf "><?= $review['user_name']?> : </span><span><?= date('M j Y g:i A', strtotime($review['timeAdded']))?></span>
                                    <input id="input-2c" name="ratingStrShow" class="rating" min="0" max="5" step="0.1"
                                           value="<?=$review['rating']?>" data-size="xxs" data-show-caption="false" data-glyphicon="false"
				...
				<div class="modal-content">
					...
					<form role="form" method="POST" enctype="multipart/form-data" action="addProductReview">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-warning" data-dismiss="modal" style="width: 70px">Close</button>
		...
		<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
			...
			<div class="modal-dialog modal-dialog-center">
				<div class="modal-content">
                    ...
                    <form role="form" method="POST" action="/Ambula/FoodProducts/updateUserReview/<?= $userEditReview[0]['idproduct_review']?>">
                        <div class="modal-body">
                            <div class="col-lg-4" style="border: none; height: 100%;">
                                <img class="img-thumbnail" src="/Ambula/<?= $product[0]['img_url'] ?>"/>
                            ...
                            <div class="col-lg-8" style="border: none; height: 100%;">
                                    <div class="form-group">
                                        <textarea class="form-control reviewDesc" rows="13" id="" name="editReviewTxt" style="margin-bottom: 5px"><?= $userEditReview[0]['review']?></textarea>
                                        <input id="inputStar" name="ratingStrEdit" class="rating" min="0" max="5" step="0.1"
                                               value="<?= $userEditReview[0]['rating']?>" data-size="xs" data-show-caption="true" data-glyphicon="false"
                                               value="0" data-rating-class="rating-fa">
                                    </div>
                            </div>
                        </div>
		...
		<div class="col-lg-3" style="height: 700px">
			<div class="row card" style="margin-left: 5px; margin-right: 0px; display: inline-block; overflow: auto; min-width: 340px; min-height: 695px">
	...
	<div class="row moreAndRelRecipes card">
		...
		<div class="col-lg-6 row2" style="border-right: 1px solid #FF9B33">
            ...
            <div class="col-sm-6 col-md-4" style="padding: 5px">
			    <div class="thumbnail" data-link="/Ambula/FoodProducts/product?productId=<?= $ownerProduct['idproducts'] ?>">
				    <a class="inner box">
					    <img class="product_thumb" src="/Ambula/<?= $ownerProduct['img_url'] ?>" style="display:block;width: 242px; height: 200px;">
