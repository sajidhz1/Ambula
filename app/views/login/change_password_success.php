                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <?php } else if (isset($_GET["password_changed"])) { ?>
                                ...
                                <p>Your password has been Successfully changed <label><a href="/Ambula/login">Login
                                            here</a></label></p>
                            <?php } else if (isset($_GET["reset_link_expired"])) { ?>
                                <h3 class="text-center txt-red">Password Reset link Expired</h3>
                                <p>Your password reset link has expired Request for a new one <label><a
                                            href="/Ambula/login/passwordReset">Click Here</a></label></p>
                            <?php } ?>
                        </div>
                    </div>
                </div>
